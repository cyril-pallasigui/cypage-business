		...
		<?php endif; ?>
				...
				<div id="navbarNavDropdown" class="collapse navbar-collapse">
					<ul id="main-menu" class="navbar-nav ml-auto">
						...
						<?php if (get_theme_mod('recognitions_enabled', 'yes') === 'yes') { ?><li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-recognitions" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-recognitions nav-item"><a title="<?php echo get_theme_mod('recognitions_heading', 'Recognitions'); ?>" href="<?php echo (is_front_page() && is_home()) ? '#recognitions' : esc_url(get_home_url( NULL, '#recognitions' )); ?>" class="nav-link"><?php echo get_theme_mod('recognitions_heading', 'Recognitions'); ?></a></li><?php } ?>
